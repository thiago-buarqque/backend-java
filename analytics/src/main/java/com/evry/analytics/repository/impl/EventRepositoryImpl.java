...
public class EventRepositoryImpl implements CustomEventRepository {
    ...
    public void deleteByUserId(String userId) {
        ...
        DeleteUsingStep<Record> deleteUsingStep = _dslContext.deleteFrom(DSL.table("Event"));

        deleteUsingStep.where(DSL.field("userId", String.class).eq(userId)).executeAsync();
    }
